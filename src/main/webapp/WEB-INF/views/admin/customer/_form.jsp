		...
		<form:form action="${base}/index" modelAttribute="entity" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<div class="form-control">
						<form:radiobutton path="activated" value="true" label="Kịch Hoạt" />
						<form:radiobutton path="activated" value="false" label="Không Kích Hoạt" />
					</div>
				</div>
				<div class="form-group col-sm-6">
			...
			<div class="row">
				...
				<div class="form-group col-sm-12">
					...
					<button class="btn btn-warning" formaction="${base}/update">Chỉnh Sửa</button>
